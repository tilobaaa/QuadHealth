    ...
    <div className="my-6">
      ...
      <div className="flex gap-2">
        {specialityData.map((specialty) => {
          return (
            <div key={specialty.title} className="flex-1  border border-primary-200 rounded-sm bg-primary-100 flex flex-col items-center p-4 cursor-pointer hover:scale-105 transition-all duration-500 ">
