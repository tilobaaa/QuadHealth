...
const Auth = () => {
  ...
  return (
    <div className="flex-grow flex flex-col justify-center w-full bg-grey-100 relative">
      <div className="bg-grey-50 m-6 sm:m-auto p-10 sm:w-1/3 ">
        ...
        <div className="mt-4 sm:mt-6 ">
          <p className="text-2xl sm:text-4xl font-medium text-primary-500">
        ...
        <div className="flex my-10 w-full">
          <div className="border border-grey-300 rounded-sm bg-grey-50 flex-1 h-12 sm:h-20 p-4"></div>
          <div className="border border-grey-300 rounded-sm bg-grey-50 flex-1 h-12 sm:h-20 p-4"></div>
          <div className="border border-grey-300 rounded-sm bg-grey-50 flex-1 h-12 sm:h-20 p-4"></div>
          <div className="border border-grey-300 rounded-sm bg-grey-50 flex-1 h-12 sm:h-20 p-4"></div>
          <div className="border border-grey-300 rounded-sm bg-grey-50 flex-1 h-12 sm:h-20 p-4"></div>
