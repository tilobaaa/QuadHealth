  ...
  return (
    <div className="flex-grow bg-grey-100 py-10 px-20">
      ...
      <div className="absolute w-full h-full top-0 left-0 flex">
        <div className="w-full h-full top-0 left-0 bg-grey-400 relative opacity-50"></div>
        <div className="absolute top-1/2  p-10 border border-grey-300 rounded-sm bg-grey-50 flex flex-col gap-10 m-auto w-1/3">
          <div className="flex justify-between items-center">
            <h1>Review your Booking Information</h1>
            <img src="" alt="/assets/x-close.svg" />
          </div>
          <div className="flex gap-2">
            <img
              className="w-28 h-28"
          ...
          <div>
            ...
            <div>
              <p>Date and Time</p>
              <p>Saturday, 22 February, 2025 | 8:30 am</p>
            </div>
            <div>
              <p>Insurance Provider and Policy Number</p>
              <p>Leadway Health | 12345678</p>
            </div>
            <div className="flex items-center">
              <input type="checkbox" name="confirmInfo" id="confirmInfo" />
              <label htmlFor="confirmInfo">
                I confirm that the information provided is accurate and belongs
                to me and Quad Health is not liable for any incorrect details
                submitted.
              </label>
            </div>
          </div>
